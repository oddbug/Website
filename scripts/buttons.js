    ...
    try {
        ...
        if (document.getElementById("coolsiteButtons")) {
            const coolsites = [
                ...
                {title: "✦ rice.place", alt: "Rice place button", button: "riceplace", link: "rice.place"},
                {title: "✦ strawbunimilk | cute art and site", alt: "strawbunimilk", button: "strawbunimilk", link: "strawbunimilk.neocities.org"},
        ...
        if (document.getElementById("recourceButtons")) {
            const recources = [
                {title: "itinerae | cute graphics", alt: "Itinerae button", button: "itinerae", link: "www.itinerae.org"},
                {title: "moosyu | very helpful guides", alt: "Moosyu button", button: "moosyu", link: "moosyu.github.io"},
                {title: "PetraPixel | guides, cheatsheets, and tutorials", alt: "Petra pixel button", button: "petrapixel", link: "petrapixel.neocities.org"}
            ];
